(* Task : Define a record type to represent a triangle in 3-dimensional space. Use a tuple to store the coordinates of each vertex.
...
let t1 = {p1=(0., 0., 0.); p2=(2., 0., 0.); p3=(1., 1.73151967898468873, 0.)};;
